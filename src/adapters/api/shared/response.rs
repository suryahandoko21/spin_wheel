...
impl SpinResponse {
    pub fn new(status: String, reward: Option<SpinRewardEntity>) -> Self {
        SpinResponse { status, reward }
    }
}
...
impl TicketResponse {
    pub fn new(status: String, message: String, data: Vec<HashMap<String, String>>) -> Self {
        TicketResponse {
            status,
            message,
            data,
...
impl SpinAvailableResponse {
    pub fn new(message: String, spin_amount: i64, available: bool) -> Self {
