use crate::{
    adapters::{api::{    
        shared::{app_state::AppState,error_presenter::ErrorReponse, response::GenericResponse}, spin_lists::{spin_list_mappers::SpinListPrizesPresenterMapper, spin_list_presenters::SpinListsPrizesPresenter, spin_list_payloads::SpinListPayload}
    }},
    application::{
        mappers::api_mapper::ApiMapper,
        usecases::{interfaces::AbstractUseCase, spin_lists::{get_all_spin_lists_usecase::GetAllSpinListsUseCase, find_by_id_usecase::GetOneSpinListsByIdUseCase, post_one_spin_list_usecase::PostSpinListsUseCase,delete_by_id_usecase::DeleteOneSpinListsByIdUseCase,update_one_spin_list_usecase::UpdateSpinListsUseCase}}
...
pub fn routes(cfg: &mut web::ServiceConfig) {
    ...
    .service(get_one_spin_list_by_id)
