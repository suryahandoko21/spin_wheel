...
use crate::{
    ...
    domain::{ error::ApiError, spin_lists_entity::SpinListsPrizesEntity}, adapters::api::{spin_lists::spin_list_payloads::SpinPostPayload, shared::response::GenericResponse},
};
