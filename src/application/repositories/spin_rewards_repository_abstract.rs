...
use crate::{adapters::api::{spin_reward::{spin_reward_payload::{SpinRewardPayload, SpinRewardUpdatedPayload}, query_string::QstringReward}, shared::response::GenericResponse}, domain::spin_reward_entity::SpinRewardEntity};
